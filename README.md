...
- [x] Поддержка списковых и ассоциативных массивов
- [x] Поддержка phpdoc для уточнения типов
- [x] Поддержка обобщенных типов с произвольным числом параметров
- [x] Переопределение геттеров и сеттеров для свойств
- [x] Поддержка классов **Date/Time** и **SPL**.
- [ ] Поддержка классов-перечислений (см. [Классы Перечислений](#классы-перечислений-enum))
